...
TASKS = {
    1: {
        ...
        "instructions": (
            ...
            "at the right growth stages (development stage ~0.3 and ~0.6) and harvest "
            "when the crop reaches maturity (DVS >= 1.8). Irrigation is rarely needed. "
    ...
    2: {
        ...
        "instructions": (
            ...
            "Fertilize near development stages 0.3 and 0.6. Harvest at DVS >= 1.8. "
            "Actions: irrigate (amount in cm), fertilize (amount in kg N/ha), harvest, "
            "or wait. "
            "\n\nScoring formula (same for all tasks): "
            "0.35×yield + 0.20×water_efficiency + 0.18×cost_efficiency "
